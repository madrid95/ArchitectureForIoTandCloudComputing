...
public class Messages {
    static class PleaseCleanupAndStop implements Serializable {
        static final long serialVersionUID = -3624342713047045790L;
    }

    static class NullMsg implements Serializable {
        static final long serialVersionUID = -3624342713047045791L;
    }

    static class FindMsg implements Serializable {
        static final long          serialVersionUID = -7142004649687677632L;
    ...
    static class WorkMsg implements Serializable {
        static final long    serialVersionUID = -2644256850271821940L;
    ...
    static class ResultMsg implements Serializable {
        static final long          serialVersionUID = -5846014651804896911L;
